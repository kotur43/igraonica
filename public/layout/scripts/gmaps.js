...
function initialize() {
    ...
    var latlang = new google.maps.LatLng(44.851320, 20.471314);
    var mapOptions = {
    ...
    infowindow.setContent('<address>Igraonica Vitez Koja<br>Trajka Grkovića 1<br>Kotež 11210<br>Tel: +381(60)100 100</address>');
